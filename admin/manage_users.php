                    ...
                    <form id="addUserForm" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="password" id="add_user_password" class="form-control" required>
                                <span class="input-group-text toggle-password" style="cursor: pointer;" onclick="togglePassword('add_user_password', this)">
                            ...
                            <div class="modal-body">
                                <form id="changePasswordForm">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                            <input type="password" name="new_password" id="modal_new_password" class="form-control" required>
                                            <span class="input-group-text toggle-password" style="cursor: pointer;" onclick="togglePassword('modal_new_password', this)">
                                                <i class="fas fa-eye"></i>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="confirm_new_password" id="modal_confirm_new_password" class="form-control" required>
                                            <span class="input-group-text toggle-password" style="cursor: pointer;" onclick="togglePassword('modal_confirm_new_password', this)">
                                                <i class="fas fa-eye"></i>
                                            </span>
                                        </div>
                                    </div>
