                            ...
                            <form id="changePasswordForm">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text toggle-password" style="cursor: pointer;" onclick="togglePassword('current_pass', this)">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text toggle-password" style="cursor: pointer;" onclick="togglePassword('new_pass', this)">
                                            <i class="fas fa-eye"></i>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text toggle-password" style="cursor: pointer;" onclick="togglePassword('confirm_new_pass', this)">
                                            <i class="fas fa-eye"></i>
                                        </span>
                                    </div>
                                </div>
