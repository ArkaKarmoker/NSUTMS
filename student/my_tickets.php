                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-info text-dark">
                                                    <?php echo !empty($ticket['payment_method']) ? ucfirst(htmlspecialchars($ticket['payment_method'])) : 'None'; ?>
                                                </span>
                                            </td>
                                            <td>
                                                <?php 
                                                ...
                                                ?>
                                                <span class="badge <?php echo $pClass; ?>"><?php echo ucfirst($ticket['payment_status']); ?></span>
                                            </td>
                                            <td>
                                                <?php 
