...
$stmt = $conn->prepare("
    SELECT r.*, d.name as dest_name, d.start_map_coords, d.end_map_coords, bt.time as actual_time
    FROM rides r 
    JOIN destinations d ON r.destination_id = d.id 
    JOIN bus_times bt ON r.time_id = bt.id
                    ...
                    <?php else: ?>
                        <div class="alert alert-success border-success">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3"><strong>Time:</strong> <?php echo $current_ride['actual_time']; ?></div>
